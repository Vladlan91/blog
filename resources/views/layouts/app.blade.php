            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="dropdown" >
                            <a href="#" class="dropdown-toggle des" data-toggle="dropdown" style="" role="button">Підбір покриття <span class="caret"></span></a>
...
{{--                                <li><a href="#">За параметрами</a></li>--}}
                        ...
                        <li class="dropdown">
                            <a href="{{route('page','history')}}" class="dropdown-toggle" data-toggle="dropdown" role="button">Про компанію <span class="caret"></span></a>
                        </li>
                        <li class="dropdown">
                            <a href="" class="dropdown-toggle" data-toggle="dropdown" role="button">
                                НАШІ ПОСЛУГИ <span class="caret"></span></a>
                            <ul class="dropdown-menu multi-level">
                                <li class="dropdown dropdown-submenu">
                                    <a href="{{route('page','promyslovi-pidlogy')}}" class="dropdown-toggle" data-toggle="dropdown">Промислові покриття</a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="{{route('page','poliuretanova-pidloga')}}">ПОЛІУРЕТАНОВА ПІДЛОГА</a></li>
                                        <li><a href="{{route('page','nalivna-pidloga')}}">НАЛИВНА ПІДЛОГА</a></li>
{{--                                        <li><a href="{{route('page','poliuretan-czement')}}">ПОЛІУРИТАН-ЦЕМЕНТ</a></li>--}}
                                    </ul>
                                </li>
                                <li class="dropdown dropdown-submenu">
                                    <a href="{{route('page','dekorativni-pokrittya')}}" class="dropdown-toggle" data-toggle="dropdown">Декоративні покриття</a>
                                    <ul class="dropdown-menu">
                                ...
                                <li class="dropdown dropdown-submenu">
                                    <a href="{{route('page','pidloga-dlya-medychnyh-zakladiv')}}" class="dropdown-toggle" data-toggle="dropdown">Медичні покриття</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{route('page','poliuretanova-pidloga')}}">ПОЛІУРЕТАНОВА ПІДЛОГА</a></li>
                                        <li><a href="{{route('page','promislove-kvarcove-pokrittya')}}">ПРОМИСЛОВИЙ КВАРЦ</a></li>
                                        <li><a href="{{route('page','epoksidnij-okras')}}">ЕПОКСИДНИЙ ОКРАС</a></li>
                                ...
                                <li class="dropdown dropdown-submenu">
                                    <a href="{{route('page', 'remont-betonu-ta-betonnyh-pokryttiv')}}" class="dropdown-toggle" data-toggle="dropdown">Ремонт бетону та топінгу</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{route('page','remont-styazhki')}}">РЕМОНТ БЕТОННИХ СТЯЖОК</a></li>
                                        <li><a href="{{route('page','remont-napivsukhikh-styazhok')}}">РЕМОНТ НАПІВСУХИХ СТЯЖОК</a></li>
                                        <li><a href="{{route('page','shlifuvannya-betonu-v-stili-loft')}}">ШЛІФУВАННЯ БЕТОНУ / LOFT</a></li>
                                        <li><a href="{{route('page','remont-betonu-ta-toppingu')}}">РЕМОНТ БЕТОНУ / ТОПІНГ</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li><a href="{{route('page','project/')}}">Проекти</a></li>
...
{{--                        </li>--}}
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">Корисне <span class="caret"></span></a>
                            <ul class="dropdown-menu multi-level">
                                <li><a href="{{route('page', 'history/')}}">Про компанію</a></li>
{{--                                <li><a href="#">ПРАЙС ЦІН НА РОБОТИ</a></li>--}}
{{--                                <li><a href="#">Співпраця з нами</a></li>--}}
{{--                                <li><a href="#">Франшиза</a></li>--}}
{{--                                <li><a href="{{route('page','projects/')}}">Проекти</a></li>--}}
                                <li><a href="{{route('page','dizajn-ta-arhitektura')}}">Дизайн / архітектура</a></li>
                                <li><a href="{{route('page', 'contact/')}}">Контакти</a></li>
                            </ul>
                        </li>
                    </ul>
                    <div class="nav navbar-nav navbar-right">
                        <div class="custom-area">
                            <a class="md-trigger btn btn-sm" target="_blank"  href="{{route('comerc')}}" >ОТРИМАТИ КОМЕРЦІЙНУ ПРОПОЗИЦІЮ</a>
                        </div>
...
<footer class="footer-base">
    <div class="container content">
        <div class="row">
            ...
            <div class="col-md-4">
                <h3 class="text-black text-uppercase">КОНТАКТНА ІНФОРМАЦІЯ</h3>
            ...
            <div class="col-md-4">
                <h3 class="text-black text-uppercase">ВАЖЛИВІ ПОСИЛАННЯ</h3>
                <hr class="space space-30" />
                <div class="footer-menu text-s">
                    <a href="#">НОВИНИ</a>
                    <a href="{{route('page', 'history')}}">ПРО НАС</a>
                    <a href="#">ПІДПИСКА</a>
