...
@section('title', 'Микроцемент')
@section('meta', 'Микроцемент | ИВ БУД')
@section('keywords', 'Микроцемент | ИВ БУД')
@section('breadcrumbs')
@endsection
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <ol class="breadcrumb b white">
                        ...
                        <li class="active" style="color: #F5BF23!important;">Микроцемент</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    ...
                    <aside class="sidebar mi-menu">
                        <nav class="sidebar-nav">
                            <ul class="side">
                                <li> <a href="#top">Микроцемент</a></li>
                                <li> <a href="#top2">ПРОЦЕСС СОЗДАНИЯ ПОКРЫТИЯ</a></li>
                                <li><a href="#top3">
                                        Гарантийные обязательства</a></li>
                ...
                <div class="col-md-9 col-sm-8">
                    ...
                    <ul class="fa-ul text-s ul-dots">
                        <li>покрытие резкой пятнистости (LOFT)</li>
                        <li><a style="color: #F5BF23" href="{{route('page','polimernij-mikrocement')}}">покрытие умеренной пятнистости / однотонный текстуры</a></li>
                    </ul>
                    <p>
                    ...
                    <h2>МИКРОЦЕМЕНТ.</h2>
                    <p>
                        Микроцемент - это декоративное покрытие на основе цемента, в нашем случае еще и полимеров на водной основе, добавок и минеральных пигментов. Четкие черты - резкие пятнистости, потертости и текстура, которую создает шпатель, присущей лофт стилю. Этот материал идеально подходит как для внутренних поверхностей, наносится на полы, стены, потолки и т.д. И самое главное - это полностью бесшовное покрытие! Отсутствие швов облегчает уборку и обслуживание.
