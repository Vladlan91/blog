    ...
    <div class="container">
        <div class="col-12 text-center">
            <div class="home-wrapper">
                ...
                <p>Выберите тип напольного покрытия.</p>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                    ...
                                    <div class="hori-timeline">
                                        <div class="owl-carousel owl-theme  navs-carousel events" id="timeline-carousel">
                                            @foreach($types as $item )
                                                ...
                                                `       </span>
                                                                <br>
                                                                <h4 class="card-title" style="height: 50px;">{{$item->name_ru}}</h4>
                                                                <p><a href="{{route('page', $item->slug)}}" target="_blank">Ознакомиться с покрытием.</a></p>
                                                                        ...
                                                                        <div class="button-items">
                                                                                <div class="row ">
                                                                                    ...
                                                                                    <div class="col-sm-6 col-6">
                                                                                        <a type="button" class="popup-youtube btn btn-warning waves-effect btn-label waves-light " href="{{$item->video}}"><i class="bx bx-video label-icon "></i> Видео</a>
                                                                                    </div>
                                                                                    @endif
                                                                                    <div class="col-sm-6 col-6">
                                                                                        <a type="button" class="btn btn-primary  waves-effect btn-label waves-light" href="{{route('comerc.stepThree',  [$item, $id])}}"><i class="bx bx-smile label-icon"></i> Выбрать</a>
                                                                                    </div>
                                                                                </div>
                                                                        </div>
                                                                    </div>
