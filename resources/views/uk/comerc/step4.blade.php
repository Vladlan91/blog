                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-6">
                                    <address>
                                        <strong>Від кого:</strong><br>
                                            <i class="bx bx-code font-size-14" style="color: #eea236; margin-right: 5px;"></i>ТОВ "ІВ БУД"<br>
                                            <i class="bx bx-code font-size-14" style="color: #eea236; margin-right: 5px;"></i>Код ЄДРПОУ 43143861<br>
                                            <i class="bx bx-code font-size-14" style="color: #eea236; margin-right: 5px;"></i>ІПН: 431438609037<br>
                                    ...
                                    <address class="mt-2 mt-sm-0">
                                        <strong>контактні дані:</strong><br>
                                            ...
                                            <i class="bx bx-map font-size-14" style="color: #eea236; margin-right: 5px;"></i>м. Львів, Наливайка 12<br>
                                    </address>
                                </div>
                            ...
                            <div class="py-2 mt-3">
                                <h5 class="font-size-13 font-weight-bold" style="font-weight: bold;">Надає комерційну пропозицію на "{{$comercel->floor->name}}".</h5>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <th>тип покриття</th>
                                        <th class="text-end">ціна, грн/м2.</th>
                            ...
                            <div class="table-responsive">
                                <table class="table table-nowrap">
                                    ...
                                    @if($comercel->floor_quality < 50)
                                        <tr>
                                            <td>{{$i += 1}}</td>
                                            <td>Ремонтування та вирівнювання стяжки</td>
                                    ...
                                    @if($comercel->damfer !== null)
                                        <tr>
                                            <td>{{$i += 1}}</td>
                                            <td>Демонтаж демферної стрічки</td>
                                            <td class="text-end"></td>
                                            <td class="text-end"></td>
                                    ...
                                    <tr>
                                        <td>{{$i += 1}}</td>
                                        <td>Доставка метеріалів на об'єкт</td>
                                        <td class="text-end"></td>
                                        <td class="text-end"></td>
                                        <td class="text-end">0</td>
                                    </tr>
                            ...
                            <div class="d-print-none">
                                <div class="float-end">
                                    <a href="javascript:window.print()" class="btn btn-success waves-effect waves-light me-1"><i class="fa fa-print"></i> Зберегти в PDF</a>
                                    <a href="{{route('home')}}" class="btn btn-primary waves-effect waves-light me-1"><i class="fa fa-home"></i> На головну</a>
                                </div>
                            </div>
                        </div>
                    </div>
