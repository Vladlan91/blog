@extends('layouts.app')
@section('title', 'Поліуретан-цемент')
@section('meta', 'Поліуретан-цемент | ІВ БУД')
@section('keywords', 'Поліуретан-цемент | ІВ БУД')
@section('breadcrumbs')
@endsection
@section('content')
    <div class="header-title ken-burn-out white" data-parallax="scroll" data-natural-height="800" data-natural-width="1920" data-image-src="../prodgect/pr-4.png">
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <div class="title-base text-left">
                        <hr class="anima" />
                        <h1>Поліуретанове покриття</h1>
                        <p>Покриття підходить для приміщень, де до підлог пред’являються специфічні вимоги.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <ol class="breadcrumb b white">
                        <li><a style="color: white;" href="{{route('home')}}">Головна</a></li>
                        <li class="active" style="color: #F5BF23!important;">Поліуретанове покриття</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container content">
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    ...
                    <aside class="sidebar mi-menu">
                        <nav class="sidebar-nav">
                            <ul class="side">
                                <li> <a href="#top">ПОЛІУРИТАНОВА ПІДЛОГА</a></li>
                ...
                <div class="col-md-9 col-sm-8">
                    ...
                    <h2>ПРО ПОКРИТТЯ.</h2>
                    <p>
                        Полімерне покриття з поліуретану широко застосовується для підлогових конструкцій з бетону, металу і дерева. Мета нанесення – захистити перекриття від викришування і промокання, створити міцну, еластичну і зносостійку поверхність. Суміш підходить для приміщень, де до підлог пред’являються специфічні вимоги:
                    </p>
                    <ul class="fa-ul text-s ul-dots">
                        <li>Зносостійкість;</li>
                        <li>Стійкість до вібрацій;</li>
                        <li>Протиковзання;</li>
                        <li>Антистатичність;</li>
                        <li>Привабливий вигляд, оригінальний дизайн;</li>
                        <li>Санітарна гігієна, антибактеріальність;</li>
                        <li>Непромокаємість;</li>
                        <li>Легке прибирання, необхідність миття водою із застосуванням побутової хімії.</li>
                    </ul>
                    <hr class="space m" />
                    <a name="top"></a>
                    <hr>
                    <h2>ПОЛІУРИТАНОВА ПІДЛОГА.</h2>
                    <p>
                        Міцне і зносостійке покриття для підлоги – необхідна складова облаштування виробничого приміщення. Грамотний монтаж підвищить комфорт в процесі пересування, усуне ковзання по поверхні, зробить технологічний процес швидше і якісніше. Плюси і мінуси поліуретанової наливної підлоги – інформація, яка допоможе визначитися з вибором відповідного варіанту.
                    </p>
                    <hr class="space" />
                    ...
                    <p>
                    <p>
                        Процес нанесення поліуританового покриття починається з якісної підготовки основи, саме це впливає на довговічність покриття. Як будь яке покриття, від Компанії ІВ БУД, все починається з підготовки основи, у випадку, якщо основа має дефекти та нерівності ми виконуємо
                    ...
                    <h2>ЦІНА РОБІТ.</h2>
                    <p>
                        Всі роботи, які включає в себе декоративне покриття і їхня вартість, вказано екремо.
                    </p>
                    <p>
                        Вартість робіт:
                    </p>
                    <ul class="fa-ul text-s ul-dots">
                        ...
                        <li>Нанесення поліуретану - ціна 350 грн/м2</li>
                    ...
                    <ul class="fa-ul text-s ul-dots">
                        ...
                        <li>Поліуретан - ціна 570 грн/м2</li>
                        <li>Eпоксидний грунт - ціна 280 грн/м2</li>
                        <li>Кварцовий пісок - ціна 100 грн/м2</li>
                    </ul>
                    <hr>
                    <p>
                    <p>
                        Загальна вартість робіт, з врахуванням всіх етапів складатиме - 2000 грн/м2 (Європейський Сертифікат ).  Загальна вартість робіт, з врахуванням всіх етапів складатиме - 3000 грн/м2 (Український Сертифікат ) Також можлива знижка до 10%, при площі 200+.
                    </p>
                    <hr>
